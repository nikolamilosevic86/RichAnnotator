function XmlToolBox() {
    var O = 'bootstrap',
        ...
        _b = 'XmlToolBox.devmode.js',
        ac = '0A04F0DDB763535EA6407063165DC62A',
        bc = '27C4123F502ED347157DF8D2C6C20127',
        cc = '92522C202F7559B1848AD795DD466AA6',
        dc = 'D2799D7ECC3F3F9924104188F27644DF',
        ec = 'EFD32C935AE84FA9B75A9DDF346EAAD2',
        fc = ':',
        gc = '.cache.js',
        hc = 'loadExternalRefs',
        ic = 'end',
        ...
        kc = 'file:',
        lc = '_gwt_dummy_',
        mc = '__gwtDevModeHook:XmlToolBox',
    ...
    XmlToolBox.__sendStats = r;
    XmlToolBox.__moduleName = S;
    XmlToolBox.__errFn = null;
    XmlToolBox.__moduleBase = U;
    XmlToolBox.__softPermutationId = V;
    XmlToolBox.__computePropValue = null;
    XmlToolBox.__getPropMap = null;
    XmlToolBox.__installRunAsyncCode = function() {};
    XmlToolBox.__gwtStartLoadingFragment = function() {
        return null
    };
    XmlToolBox.__gwt_isKnownPropertyValue = function() {
        return false
    };
    XmlToolBox.__gwt_getMetaProperty = function() {
        return null
    };
    var s = null;
    ...
    XmlToolBox.__moduleStartupDone = function(e) {
        var f = t[S].bindings;
        t[S].bindings = function() {
            var a = f ? f() : {};
            var b = e[XmlToolBox.__softPermutationId];
    ...
    function A(k) {
        ...
        XmlToolBox.onScriptDownloaded = function(a) {
            l(function() {
                m(a)
            })
        };
        ...
        n.src = k;
        if (XmlToolBox.__errFn) {
            n.onerror = function() {
                XmlToolBox.__errFn(S, new Error(nb + code))
            }
        }
        p.getElementsByTagName(ob)[V].appendChild(n)
    }
    XmlToolBox.__startLoadingFragment = function(a) {
        return D(a)
    };
    XmlToolBox.__installRunAsyncCode = function(a) {
        var b = v();
        var c = b.body;
    ...
    function D(a) {
        ...
        return XmlToolBox.__moduleBase + a
    }
    ...
    function F() {
        ...
        XmlToolBox.__getPropMap = function() {
            var a = {};
            for (var b in i) {
        ...
        XmlToolBox.__computePropValue = k;
        o.__gwt_activeModules[S].bindings = XmlToolBox.__getPropMap;
        r(O, $b);
        if (q()) {
            return D(_b)
        }
        ...
        XmlToolBox.__softPermutationId = g;
        return D(l + gc)
    }
    ...
    B();
    XmlToolBox.__moduleBase = C();
    t[S].moduleBase = XmlToolBox.__moduleBase;
    var H = F();
    if (o) {
...
XmlToolBox.succeeded = XmlToolBox();